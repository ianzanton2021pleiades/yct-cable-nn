...
DG_MODULE_PATH = SCRIPT_DIR / "DG_dataset_max2.5km.py"
...
class DGSingleSampleGUI:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("DG 2.5km Single Sample Analyzer")
    ...
    def parse_config(self) -> dict:
        ...
        return {
            ...
            "real_data_root": DEFAULT_REAL_DATA_ROOT,
        }
    ...
    def _update_status(self, sample: dict) -> None:
        ...
        source_text = "；".join(sources) if sources else "无模板/校准源"
