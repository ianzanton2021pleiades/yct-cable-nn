"""Broadband cascaded-transmission-line S11 generator for DG V2.
...
class SweepConfig:
    ...
    start_hz: float = 9e3
    stop_hz: float = 1e9
    n_points: int = 50000  # DG V2 full-sweep standard
...
def _compute_s11_for_cable(
    ...
    V2 keeps all visible effects in frequency domain.  In addition to skin
